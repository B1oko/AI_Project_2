...
class MultiApp:
    ...
    def run(self):
        ...
        # insertar logo
        st.logo("./img/logo3.png", size="large")
        ...
        github_svg="""
            <svg height="16" aria-hidden="true" viewBox="0 0 24 24" version="1.1" width="32" data-view-component="true" class="octicon octicon-mark-github v-align-middle">
        ...
        st.sidebar.markdown(f"""
            <div class="sidebar-footer">
                ...
                <p>{github_svg}<a href="https://github.com/B1oko" target="_blank">Pablo Esteban</a></p>
                <p>{github_svg}<a href="https://github.com/paujorques02" target="_blank">Pau Jorques</a></p>
                <p>{github_svg}<a href="https://github.com/VeintimillAlejandro" target="_blank">Alejandro Veintimilla</a></p>
            </div>
